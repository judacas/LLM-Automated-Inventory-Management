...
canonicalUrl: https://learn.microsoft.com/en-us/python/api/overview/azure/ai-projects-readme?view=azure-python
config_moniker_range: azure-python-preview
uhfHeaderId: Azure
...
ms.service: ai
locale: en-us
document_id: cc6e78de-3a52-894f-4a3f-4298ba475c16
document_version_independent_id: cbce1de4-1962-d40e-dc99-230e62d876f7
updated_at: 2026-02-25T12:08:00.0000000Z
original_content_git_url: https://github.com/MicrosoftDocs/azure-docs-sdk-python/blob/live/docs-ref-services/preview/ai-projects-readme.md
gitcommit: https://github.com/MicrosoftDocs/azure-docs-sdk-python/blob/b48204117704a25ad0c87028520ec26fa0d47a12/docs-ref-services/preview/ai-projects-readme.md
git_commit_id: b48204117704a25ad0c87028520ec26fa0d47a12
...
word_count: 5244
asset_id: api/overview/azure/ai-projects-readme
moniker_range_name: 932b238285540debb6ea744425092f47
monikers:
- azure-python-preview
item_type: Content
source_path: docs-ref-services/preview/ai-projects-readme.md
cmProducts:
...
- **Explore additional evaluation tools (some in preview)** to assess the performance of your generative AI application, using the `.evaluation_rules`, `.beta.evaluation_taxonomies`, `.beta.evaluators`, `.beta.insights`, and `.beta.schedules` operations.
...
[Product documentation](https://aka.ms/azsdk/azure-ai-projects-v2/product-doc) | [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) | [API reference](https://aka.ms/azsdk/azure-ai-projects-v2/python/api-reference) | [Package (PyPI)](https://aka.ms/azsdk/azure-ai-projects-v2/python/package) | [SDK source code](https://aka.ms/azsdk/azure-ai-projects-v2/python/code) | [Release history](https://aka.ms/azsdk/azure-ai-projects-v2/python/release-history)
...
- A [project in Microsoft Foundry](/en-us/azure/ai-studio/how-to/create-projects).
...
- An Entra ID token for authentication. Your application needs an object that implements the [TokenCredential](/en-us/python/api/azure-core/azure.core.credentials.tokencredential) interface. Code samples here use [DefaultAzureCredential](/en-us/python/api/azure-identity/azure.identity.defaultazurecredential). To get that working, you will need:
    - An appropriate role assignment. See [Role-based access control in Microsoft Foundry portal](/en-us/azure/ai-foundry/concepts/rbac-foundry?view=foundry). Role assignment can be done via the "Access Control (IAM)" tab of your Azure AI Project resource in the Azure portal.
    - [Azure CLI](/en-us/cli/azure/install-azure-cli) installed.
...
See the "responses" folder in the [package samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) for additional samples, including streaming responses.
...
See the "agents" folder in the [package samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) for an extensive set of samples, including streaming, tool usage and memory store usage.
...
Agents can be enhanced with specialized tools for various capabilities. For complete working examples of all tools, see the `\agents\tools` folder under the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the basic sample in file `\agents\tools\sample_agent_code_interpreter.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.

After calling `responses.create()`, you can extract the code behind the scene from the `code_interpreter_call` output item:
...
See full sample file `\agents\tools\sample_agent_code_interpreter_with_files.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_file_search.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_image_generation.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.

**Web Search / Web Search (Preview)**

Discover up-to-date web content with the GA Web Search tool or try the Web Search Preview tool for the latest enhancements. Guidance on when to use each option is in the documentation: [https://learn.microsoft.com/azure/ai-foundry/agents/how-to/tools/web-overview?view=foundry#determine-the-best-tool-for-your-use-cases](/en-us/azure/ai-foundry/agents/how-to/tools/web-overview?view=foundry#determine-the-best-tool-for-your-use-cases).

Warning: Web Search tool uses Grounding with Bing, which has additional costs and terms: [terms of use](https://www.microsoft.com/bing/apis/grounding-legal-enterprise) and [privacy statement](https://go.microsoft.com/fwlink/?LinkId=521839&amp;clcid=0x409). Customer data will flow outside the Azure compliance boundary. Learn more [here](/en-us/azure/ai-foundry/agents/how-to/tools/web-search).

```python
tool = WebSearchTool(user_location=WebSearchApproximateLocation(country="GB", city="London", region="London"))
```

See the full sample in file `\agents\tools\sample_agent_web_search.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.

```python
tool = WebSearchPreviewTool(user_location=ApproximateLocation(country="GB", city="London", region="London"))
```

See the full sample in file `\agents\tools\sample_agent_web_search_preview.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_web_search_with_custom_search.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_computer_use.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_mcp.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_openapi.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_function_tool.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_azure_function.py` and the Azure Function implementation in `\agents\tools\get_weather_func_app.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_memory_search.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder showing how to create an Agent with a memory store, and use it in multiple conversations.

See also other samples in the folder `\memories` under [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder, showing how to manage memory stores.
...
See the full sample in file `\agents\tools\sample_agent_ai_search.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.

**Bing Grounding**

Warning: Grounding with Bing Search tool uses Grounding with Bing, which has additional costs and terms: [terms of use](https://www.microsoft.com/bing/apis/grounding-legal-enterprise) and [privacy statement](https://go.microsoft.com/fwlink/?LinkId=521839&amp;clcid=0x409). Customer data will flow outside the Azure compliance boundary. Learn more [here](/en-us/azure/ai-foundry/agents/how-to/tools/bing-tools).
...
See the full sample in file `\agents\tools\sample_agent_bing_grounding.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_bing_custom_search.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_fabric.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_sharepoint.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_browser_automation.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_mcp_with_project_connection.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_to_agent.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\tools\sample_agent_openapi_with_project_connection.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
The code below shows some evaluation operations. Full list of sample can be found under "evaluation" folder in the [package samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/)
...
The code below shows some Deployments operations, which allow you to enumerate the AI models deployed to your AI Foundry Projects. These models can be seen in the "Models + endpoints" tab in your AI Foundry Project. Full samples can be found under the "deployment" folder in the [package samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/).
...
The code below shows some Connection operations, which allow you to enumerate the Azure Resources connected to your AI Foundry Projects. These connections can be seen in the "Management Center", in the "Connected resources" tab in your AI Foundry Project. Full samples can be found under the "connections" folder in the [package samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/).
...
The code below shows some Dataset operations. Full samples can be found under the "datasets" folder in the [package samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/).
...
The code below shows some Indexes operations. Full samples can be found under the "indexes" folder in the [package samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/).
...
The code below shows some Files operations using the OpenAI client, which allow you to upload, retrieve, list, and delete files. These operations are useful for working with files that can be used for fine-tuning and other AI model operations. Full samples can be found under the "files" folder in the [package samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/).
...
You will also need an exporter to send telemetry to your observability backend. You can print traces to the console or use a local viewer such as [Aspire Dashboard](/en-us/dotnet/aspire/fundamentals/dashboard/standalone?tabs=bash).
...
See the full sample in file `\agents\telemetry\sample_agent_basic_with_azure_monitor_tracing.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\telemetry\sample_agent_basic_with_console_tracing.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.
...
See the full sample in file `\agents\telemetry\sample_agent_basic_with_console_tracing_custom_attributes.py` in the [Samples](https://aka.ms/azsdk/azure-ai-projects-v2/python/samples/) folder.

### Additional resources

For more information see:

- [Trace AI applications using OpenAI SDK](/en-us/azure/ai-foundry/how-to/develop/trace-application)

## Troubleshooting

### Exceptions

Client methods that make service calls raise an [HttpResponseError](/en-us/python/api/azure-core/azure.core.exceptions.httpresponseerror) exception for a non-success HTTP status code response from the service. The exception's `status_code` will hold the HTTP response status code (with `reason` showing the friendly name). The exception's `error.message` contains a detailed message that may be helpful in diagnosing the issue:
...
- [azure-python](https://learn.microsoft.com/en-us/python/api/overview/azure/ai-projects-readme?view=azure-python&accept=text/markdown)
