...
from mcp.tools.business_tools import (
    tool_create_business_account,
    tool_get_business_by_domain,
)
from mcp.tools.purchase_tools import (
    tool_create_purchase_order,
    tool_get_purchase_orders,
)
from mcp.tools.quote_tools import (
    tool_confirm_quote,
...
registry.register("get_quotes_by_email", tool_get_quotes_by_email)
